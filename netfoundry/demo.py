...
def main():
    ...
    if args.private:
        ...
        demo_services['hello_service']['normal_name'] = utility.normalize_caseless(demo_services['hello_service']['display_name'])
        if not demo_services['hello_service']['normal_name'] in [utility.normalize_caseless(svc['name']) for svc in services]:
            ...
            demo_services['hello_service']['entity'] = [svc for svc in services if utility.normalize_caseless(svc['name']) == demo_services['hello_service']['normal_name']][0]
        ...
        demo_services['rest_service']['normal_name'] = utility.normalize_caseless(demo_services['rest_service']['display_name'])
        if not demo_services['rest_service']['normal_name'] in [utility.normalize_caseless(svc['name']) for svc in services]:
            ...
            demo_services['rest_service']['entity'] = [svc for svc in services if utility.normalize_caseless(svc['name']) == demo_services['rest_service']['normal_name']][0]
    ...
    demo_services['fireworks_service']['normal_name'] = utility.normalize_caseless(demo_services['fireworks_service']['display_name'])
    if not demo_services['fireworks_service']['normal_name'] in [utility.normalize_caseless(svc['name']) for svc in services]:
        ...
        demo_services['fireworks_service']['entity'] = [svc for svc in services if utility.normalize_caseless(svc['name']) == demo_services['fireworks_service']['normal_name']][0]
    ...
    demo_services['weather_service']['normal_name'] = utility.normalize_caseless(demo_services['weather_service']['display_name'])
    if not demo_services['weather_service']['normal_name'] in [utility.normalize_caseless(svc['name']) for svc in services]:
        ...
        demo_services['weather_service']['entity'] = [svc for svc in services if utility.normalize_caseless(svc['name']) == demo_services['weather_service']['normal_name']][0]
    ...
    demo_services['echo_service']['normal_name'] = utility.normalize_caseless(demo_services['echo_service']['display_name'])
    if not demo_services['echo_service']['normal_name'] in [utility.normalize_caseless(svc['name']) for svc in services]:
        ...
        demo_services['echo_service']['entity'] = [svc for svc in services if utility.normalize_caseless(svc['name']) == demo_services['echo_service']['normal_name']][0]
    ...
    if not utility.normalize_caseless(customer_router_name) in [utility.normalize_caseless(er['name']) for er in customer_routers]:
        ...
        customer_router = [er for er in customer_routers if utility.normalize_caseless(er['name']) == utility.normalize_caseless(customer_router_name)][0]
    ...
    if not utility.normalize_caseless(app_wan1_name) in [utility.normalize_caseless(aw['name']) for aw in app_wans]:
        ...
        app_wan1 = [aw for aw in app_wans if utility.normalize_caseless(aw['name']) == utility.normalize_caseless(app_wan1_name)][0]
